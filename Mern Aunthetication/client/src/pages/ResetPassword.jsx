...
const onSubmitewPassword = async(e)=>{
  e.preventDefault()
  try {
 ...
 {!isEmailSent &&
      ...
      <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'> 
        ...
        <input value={email} onChange={(e)=>setEmail(e.target.value)} required  type="email" placeholder='Enter your email' className='bg-transparent outline-none text-white'/>
      </div>
...
<form onSubmit={onSubmitewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
