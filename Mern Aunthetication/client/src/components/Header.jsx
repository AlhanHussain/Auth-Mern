 ...
 const {userData} =  useContext(AppContext)
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        <p className='mb-8 max-w-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, laborum praesentium! Optio incidunt, adipisci distinctio labore esse quod quidem quae.</p>
